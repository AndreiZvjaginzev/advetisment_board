                ...
                <div class="text-center">
                    ...
                    <div class="text-center">
                        <div class="bl-inl text-left form-add">
                            ...
                            @endif
                            @if(isset($myadvert) && $myadvert !=null)
                                <form name="redact" action="/cabinet/advert-request" method="post" id="main_form" enctype='multipart/form-data'> 
                                    @csrf
                                    <input type="hidden" name="form_id" id="form_id" value="{{$myadvert->id}}">
                                    ...
                                    <div class="bl-tb add-tb pos-rel zizz">
                                        ...
                                        <div class="bl-cellf bl-cell al-top zis">
                                            <input value="{{ $myadvert->title }}" placeholder="Заголовок не более 100 символов" maxlength="100" name="title" data-original-title="Сформулируете кратко основную тему сообщения" class="form-control calcletters" required="" type="text">
                                    ...
                                    <div class="bl-tb add-tb pos-rel zizz">
                                        ...
                                        <div class="bl-cellf bl-cell al-top zis">
                                            <input value="{{ $myadvert->price }}" placeholder="Цена" maxlength="100" name="price" data-original-title="Сформулируете кратко основную тему сообщения" class="form-control calcletters" required="" type="number">
                                            ...
                                            <div class="multiselect" data-action="" data-name="region" data-default="">
                                                <div>
                                                    ...
                                                    <select class="form-control" size="1" name="region">
                                                        <option value="{{ $myadvert->region->id }}">{{ $myadvert->region->name }}</option>
                                            ...
                                            <div class="multiselect" data-action="load" data-name="cat" data-default="">
                                                <div>
                                                    <select class="form-control" size="1" name="category">
                                                        <option value="{{ $myadvert->category->id }}">{{ $myadvert->category->name }}</option>
                                    ...
                                    <div class="add-tb pos-rel zizz">
                                        ...
                                        <div class="text_field bl-cellf pos-rel">
                                            <textarea required="" placeholder="Описание не более 2000 символов" maxlength="2000" class="form-control calcletters" name="content" rows="5">{{ $myadvert->description }}</textarea>
                                ...
                                <form name="add" action="advert-request" method="post" id="main_form" enctype='multipart/form-data'> 
                                    @csrf
                                    <input type="hidden" name="form_id" id="form_id" value="add">
                                    <input type="hidden" name="user_id" id="add_cat" value="{{Auth::user()->id}}">
                                    <span class="visible-xs item-tooltip striped-brand child"></span>
                                    <input type="hidden" name="add_region" id="add_region" value="">
                                    <input name="post_filter" type="hidden" value="false">
